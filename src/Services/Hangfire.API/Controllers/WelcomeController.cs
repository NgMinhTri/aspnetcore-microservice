...
namespace Hangfire.API.Controllers
{
    ...
    public class WelcomeController : ControllerBase
    {
        ...
        {
            var jobId = _scheduledJobService.Enqueue(() => ResponseWelcome("Hello world"));
        ...
        public IActionResult ConfirmedWelcome()
        {
            ...
            var parentJobId =
               _scheduledJobService.Schedule(() => ResponseWelcome("Welcome to Hangfire API"), TimeSpan.FromSeconds(5));
